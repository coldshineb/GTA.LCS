...
.method private constructor <init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/R;->c:Landroid/support/v7/widget/Toolbar;
...
.method synthetic constructor <init>(Landroid/support/v7/widget/Toolbar;B)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/R;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
.method public final a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/i;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/R;->b:Landroid/support/v7/internal/view/menu/i;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/R;->a:Landroid/support/v7/internal/view/menu/m;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/R;->b:Landroid/support/v7/internal/view/menu/i;

    iget-object v1, p0, Landroid/support/v7/widget/R;->a:Landroid/support/v7/internal/view/menu/m;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/i;->b(Landroid/support/v7/internal/view/menu/m;)Z

    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/R;->b:Landroid/support/v7/internal/view/menu/i;
...
.method public final b(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/R;->b:Landroid/support/v7/internal/view/menu/i;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/R;->b:Landroid/support/v7/internal/view/menu/i;

    invoke-virtual {v3, v1}, Landroid/support/v7/internal/view/menu/i;->getItem(I)Landroid/view/MenuItem;

    move-result-object v3

    iget-object v4, p0, Landroid/support/v7/widget/R;->a:Landroid/support/v7/internal/view/menu/m;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/R;->c(Landroid/support/v7/internal/view/menu/m;)Z
...
.method public final b(Landroid/support/v7/internal/view/menu/m;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/R;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/R;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/R;->a:Landroid/support/v7/internal/view/menu/m;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/R;->c:Landroid/support/v7/widget/Toolbar;
...
.method public final c(Landroid/support/v7/internal/view/menu/m;)Z
    ...
    iput-object v3, p0, Landroid/support/v7/widget/R;->a:Landroid/support/v7/internal/view/menu/m;
