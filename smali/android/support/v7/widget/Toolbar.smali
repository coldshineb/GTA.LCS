...
.field private D:Landroid/support/v7/app/h;

.field private final E:Landroid/support/v7/widget/m;

.field private F:Landroid/support/v7/internal/widget/Y;

.field private G:Landroid/support/v7/widget/ActionMenuPresenter;

.field private H:Landroid/support/v7/widget/R;

.field private I:Z

.field private final J:Ljava/lang/Runnable;

.field private final K:Landroid/support/v7/internal/widget/W;
...
.field private final t:Lcom/google/android/gms/common/internal/y;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->t:Lcom/google/android/gms/common/internal/y;
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/O;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/P;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-static {v0, p2, v1, p3, v6}, Lcom/google/android/vending/expansion/downloader/c;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lcom/google/android/vending/expansion/downloader/c;

    move-result-object v0

    sget v1, Landroid/support/v7/a/a;->bD:I

    invoke-virtual {v0, v1, v6}, Lcom/google/android/vending/expansion/downloader/c;->f(II)I
    ...
    invoke-virtual {v0, v1, v2}, Lcom/google/android/vending/expansion/downloader/c;->b(II)I
    ...
    sget v1, Landroid/support/v7/a/a;->bC:I
    ...
    invoke-virtual {v0, v1, v3}, Lcom/google/android/vending/expansion/downloader/c;->c(II)I
    ...
    :cond_3
    sget v1, Landroid/support/v7/a/a;->br:I
    ...
    sget v1, Landroid/support/v7/a/a;->bq:I

    invoke-virtual {v0, v1, v7}, Lcom/google/android/vending/expansion/downloader/c;->c(II)I

    move-result v1

    sget v2, Landroid/support/v7/a/a;->bn:I

    invoke-virtual {v0, v2, v7}, Lcom/google/android/vending/expansion/downloader/c;->c(II)I

    move-result v2

    sget v3, Landroid/support/v7/a/a;->bo:I

    invoke-virtual {v0, v3, v6}, Lcom/google/android/vending/expansion/downloader/c;->d(II)I

    move-result v3

    sget v4, Landroid/support/v7/a/a;->bp:I

    invoke-virtual {v0, v4, v6}, Lcom/google/android/vending/expansion/downloader/c;->d(II)I

    move-result v4

    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->t:Lcom/google/android/gms/common/internal/y;

    invoke-virtual {v5, v3, v4}, Lcom/google/android/gms/common/internal/y;->b(II)V
    ...
    :cond_4
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->t:Lcom/google/android/gms/common/internal/y;

    invoke-virtual {v3, v1, v2}, Lcom/google/android/gms/common/internal/y;->a(II)V
    ...
    sget v1, Landroid/support/v7/a/a;->bx:I
    ...
    :cond_6
    sget v1, Landroid/support/v7/a/a;->bv:I
    ...
    sget v1, Landroid/support/v7/a/a;->bu:I
    ...
    sget v1, Landroid/support/v7/a/a;->bt:I
    ...
    :cond_8
    sget v1, Landroid/support/v7/a/a;->bs:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->K:Landroid/support/v7/internal/widget/W;
...
.method private a(Landroid/view/View;I)I
    ...
    :goto_0
    iget v3, v0, Landroid/support/v7/widget/S;->a:I
    ...
    iget v7, v0, Landroid/support/v7/widget/S;->topMargin:I

    if-ge v1, v7, :cond_1

    iget v0, v0, Landroid/support/v7/widget/S;->topMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/S;->bottomMargin:I
    ...
    iget v5, v0, Landroid/support/v7/widget/S;->bottomMargin:I
...
.method private a(Landroid/view/View;I[II)I
    ...
    iget v1, v0, Landroid/support/v7/widget/S;->leftMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/S;->rightMargin:I
...
.method static synthetic a(Landroid/support/v7/widget/Toolbar;)Landroid/support/v7/app/h;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->D:Landroid/support/v7/app/h;

    return-object v0
.end method

.method private static a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/S;
    .locals 1

    instance-of v0, p0, Landroid/support/v7/widget/S;

    if-eqz v0, :cond_0

    new-instance v0, Landroid/support/v7/widget/S;

    check-cast p0, Landroid/support/v7/widget/S;

    invoke-direct {v0, p0}, Landroid/support/v7/widget/S;-><init>(Landroid/support/v7/widget/S;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/S;-><init>(Landroid/support/v7/app/b;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/S;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/S;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method private a(Landroid/view/View;)V
    ...
    invoke-static {}, Landroid/support/v7/widget/Toolbar;->i()Landroid/support/v7/widget/S;
    ...
    iput v1, v0, Landroid/support/v7/widget/S;->b:I
    ...
    invoke-static {v0}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/S;
...
.method private a(Ljava/util/List;I)V
    ...
    iget v4, v0, Landroid/support/v7/widget/S;->b:I
    ...
    iget v0, v0, Landroid/support/v7/widget/S;->a:I
    ...
    iget v5, v0, Landroid/support/v7/widget/S;->b:I
...
.method private b(Landroid/view/View;I[II)I
    ...
    iget v1, v0, Landroid/support/v7/widget/S;->rightMargin:I
    ...
    iget v0, v0, Landroid/support/v7/widget/S;->leftMargin:I
...
.method static synthetic b(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/Q;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
.method private e(Landroid/view/View;)V
    ...
    iget v0, v0, Landroid/support/v7/widget/S;->b:I
...
.method protected static i()Landroid/support/v7/widget/S;
    .locals 2
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v7/widget/S;-><init>(II)V
...
.method private k()V
    ...
    invoke-virtual {v0, v2, v2}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/support/v7/internal/view/menu/y;Landroid/support/v7/internal/view/menu/j;)V
...
.method public final a(II)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->t:Lcom/google/android/gms/common/internal/y;

    invoke-virtual {v0, p1, p2}, Lcom/google/android/gms/common/internal/y;->a(II)V
...
.method public final a(Landroid/support/v7/internal/view/menu/i;Landroid/support/v7/widget/ActionMenuPresenter;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/R;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/i;->b(Landroid/support/v7/internal/view/menu/x;)V

    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/R;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/R;-><init>(Landroid/support/v7/widget/Toolbar;B)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/R;
    ...
    invoke-virtual {v0, v1, v3}, Landroid/support/v7/widget/R;->a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/i;)V

    invoke-virtual {p2, v2}, Landroid/support/v7/widget/ActionMenuPresenter;->b(Z)V

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/R;

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/R;->b(Z)V
...
.method public final g()Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/R;->a:Landroid/support/v7/internal/view/menu/m;
...
.method public synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v7/widget/S;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-static {p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/S;
...
.method public getContentInsetEnd()I
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/internal/y;->d()I
...
.method public getContentInsetLeft()I
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/internal/y;->a()I
...
.method public getContentInsetStart()I
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/internal/y;->c()I
...
.method public getMenu()Landroid/view/Menu;
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v7/widget/R;-><init>(Landroid/support/v7/widget/Toolbar;B)V

    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/R;
...
.method public getWrapper()Landroid/support/v7/internal/widget/A;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->F:Landroid/support/v7/internal/widget/Y;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/internal/widget/Y;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->F:Landroid/support/v7/internal/widget/Y;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/aa;->i(Landroid/view/View;)I
    ...
    check-cast v3, Landroid/support/v7/widget/S;

    iget v4, v3, Landroid/support/v7/widget/S;->topMargin:I
    ...
    iget v3, v3, Landroid/support/v7/widget/S;->bottomMargin:I
    ...
    iget v9, v3, Landroid/support/v7/widget/S;->topMargin:I
    ...
    check-cast v4, Landroid/support/v7/widget/S;
    ...
    iget v0, v3, Landroid/support/v7/widget/S;->topMargin:I
    ...
    iget v3, v3, Landroid/support/v7/widget/S;->topMargin:I
    ...
    iget v5, v3, Landroid/support/v7/widget/S;->topMargin:I
    ...
    iget v4, v4, Landroid/support/v7/widget/S;->bottomMargin:I
    ...
    iget v0, v3, Landroid/support/v7/widget/S;->leftMargin:I

    move/from16 v16, v0

    sub-int v9, v16, v9

    iget v3, v3, Landroid/support/v7/widget/S;->rightMargin:I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1, v3}, Landroid/support/v7/internal/widget/ac;->a(II)I
    ...
    invoke-static {v1}, Landroid/support/v4/view/aa;->g(Landroid/view/View;)I

    move-result v1

    invoke-static {v9, v1}, Landroid/support/v7/internal/widget/ac;->a(II)I
    ...
    invoke-static {v0}, Landroid/support/v4/view/aa;->g(Landroid/view/View;)I

    move-result v0

    invoke-static {v9, v0}, Landroid/support/v7/internal/widget/ac;->a(II)I
    ...
    invoke-static {v12, v0}, Landroid/support/v7/internal/widget/ac;->a(II)I
    ...
    invoke-static {v12, v4}, Landroid/support/v7/internal/widget/ac;->a(II)I
    ...
    invoke-static {v2}, Landroid/support/v4/view/aa;->g(Landroid/view/View;)I

    move-result v2

    invoke-static {v12, v2}, Landroid/support/v7/internal/widget/ac;->a(II)I
    ...
    invoke-static {v1, p1, v2}, Landroid/support/v4/view/aa;->a(III)I
    ...
    invoke-static {v0, p2, v1}, Landroid/support/v4/view/aa;->a(III)I
...
.method public onRtlPropertiesChanged(I)V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->t:Lcom/google/android/gms/common/internal/y;

    if-ne p1, v0, :cond_1

    :goto_0
    invoke-virtual {v1, v0}, Lcom/google/android/gms/common/internal/y;->a(Z)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/R;->a:Landroid/support/v7/internal/view/menu/m;
...
.method public setLogo(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->K:Landroid/support/v7/internal/widget/W;
...
.method public setOnMenuItemClickListener$486aeec7(Landroid/support/v7/app/h;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->D:Landroid/support/v7/app/h;
