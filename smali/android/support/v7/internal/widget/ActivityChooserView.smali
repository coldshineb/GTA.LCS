...
.field private k:Landroid/support/v7/widget/z;
...
.method private a(I)V
    ...
    :goto_2
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/z;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/z;->c(I)V

    invoke-virtual {v3}, Landroid/support/v7/widget/z;->c()V

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/view/k;
    ...
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/z;->g()Landroid/widget/ListView;
...
.method private getListPopupWindow()Landroid/support/v7/widget/z;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/z;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->k:Landroid/support/v7/widget/z;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/z;->a(Landroid/view/View;)V
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->d:Landroid/support/v7/widget/x;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/x;->layout(IIII)V
...
.method public final setActivityChooserModel(Landroid/support/v7/internal/widget/n;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/widget/r;->a(Landroid/support/v7/internal/widget/n;)V
...
.method public final setProvider(Landroid/support/v4/view/k;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActivityChooserView;->a:Landroid/support/v4/view/k;
