...
.method public final a(Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, v2}, Landroid/support/v7/app/l;-><init>(Landroid/content/Context;)V

    new-instance v2, Landroid/support/v7/internal/view/menu/g;

    invoke-virtual {v1}, Landroid/support/v7/app/l;->a()Landroid/content/Context;
    ...
    invoke-virtual {v1, v2, p0}, Landroid/support/v7/app/l;->a(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/l;

    iget-object v2, v0, Landroid/support/v7/internal/view/menu/i;->c:Landroid/view/View;

    if-eqz v2, :cond_0

    invoke-virtual {v1, v2}, Landroid/support/v7/app/l;->a(Landroid/view/View;)Landroid/support/v7/app/l;

    :goto_0
    invoke-virtual {v1, p0}, Landroid/support/v7/app/l;->a(Landroid/content/DialogInterface$OnKeyListener;)Landroid/support/v7/app/l;

    invoke-virtual {v1}, Landroid/support/v7/app/l;->b()Landroid/support/v7/app/k;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/view/menu/l;->b:Landroid/support/v7/app/k;

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/l;->b:Landroid/support/v7/app/k;

    invoke-virtual {v0, p0}, Landroid/support/v7/app/k;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/l;->b:Landroid/support/v7/app/k;

    invoke-virtual {v0}, Landroid/support/v7/app/k;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/k;->show()V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/app/l;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/app/l;

    move-result-object v2

    iget-object v0, v0, Landroid/support/v7/internal/view/menu/i;->a:Ljava/lang/CharSequence;

    invoke-virtual {v2, v0}, Landroid/support/v7/app/l;->a(Ljava/lang/CharSequence;)Landroid/support/v7/app/l;
...
.method public final onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/l;->b:Landroid/support/v7/app/k;

    invoke-virtual {v1}, Landroid/support/v7/app/k;->getWindow()Landroid/view/Window;
