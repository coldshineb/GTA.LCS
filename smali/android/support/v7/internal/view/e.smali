...
.method private a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    ...
    new-instance v8, Landroid/support/v7/internal/view/g;

    invoke-direct {v8, p0, p3}, Landroid/support/v7/internal/view/g;-><init>(Landroid/support/v7/internal/view/e;Landroid/view/Menu;)V
    ...
    invoke-virtual {v8, p2}, Landroid/support/v7/internal/view/g;->a(Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {v8, p2}, Landroid/support/v7/internal/view/g;->b(Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {v8}, Landroid/support/v7/internal/view/g;->c()Landroid/view/SubMenu;
    ...
    invoke-virtual {v8}, Landroid/support/v7/internal/view/g;->a()V
    ...
    invoke-virtual {v8}, Landroid/support/v7/internal/view/g;->d()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {v8}, Landroid/support/v7/internal/view/g;->a(Landroid/support/v7/internal/view/g;)Landroid/support/v4/view/k;
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/k;->e()Z
    ...
    :cond_9
    invoke-virtual {v8}, Landroid/support/v7/internal/view/g;->b()V
