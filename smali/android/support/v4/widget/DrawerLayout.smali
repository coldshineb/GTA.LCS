...
.field private static y:Landroid/support/v4/widget/j;


# instance fields
.field private final d:Landroid/support/v4/widget/i;
...
.field private final h:Landroid/support/v4/widget/P;

.field private final i:Landroid/support/v4/widget/P;

.field private final j:Landroid/support/v4/widget/o;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->y:Landroid/support/v4/widget/j;
...
.method private a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/P;
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/P;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/aa;->b(Landroid/view/View;I)V
...
.method private a(Z)V
    ...
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/P;
    ...
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/P;->a(Landroid/view/View;II)Z
    ...
    :goto_1
    iput-boolean v3, v0, Landroid/support/v4/widget/m;->c:Z
    ...
    :cond_1
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/P;
    ...
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/P;->a(Landroid/view/View;II)Z
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/o;
...
.method static b(Landroid/view/View;)F
    ...
    iget v0, v0, Landroid/support/v4/widget/m;->b:F
...
.method private b()Landroid/view/View;
    ...
    iget-boolean v0, v0, Landroid/support/v4/widget/m;->d:Z
...
.method static c(Landroid/view/View;)Z
    ...
    iget v0, v0, Landroid/support/v4/widget/m;->a:I
...
.method private h(Landroid/view/View;)V
    ...
    iput v1, v0, Landroid/support/v4/widget/m;->b:F

    iput-boolean v2, v0, Landroid/support/v4/widget/m;->d:Z
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v4/widget/P;->a(Landroid/view/View;II)Z
...
.method final a(ILandroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/P;

    invoke-virtual {v1}, Landroid/support/v4/widget/P;->a()I

    move-result v1

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/P;

    invoke-virtual {v4}, Landroid/support/v4/widget/P;->a()I
    ...
    iget v4, v0, Landroid/support/v4/widget/m;->b:F
    ...
    iget-boolean v3, v0, Landroid/support/v4/widget/m;->d:Z
    ...
    iget-boolean v2, v0, Landroid/support/v4/widget/m;->d:Z

    if-nez v2, :cond_1

    iput-boolean v3, v0, Landroid/support/v4/widget/m;->d:Z
...
.method final a(Landroid/view/View;F)V
    ...
    iget v1, v0, Landroid/support/v4/widget/m;->b:F
    ...
    :cond_0
    iput p2, v0, Landroid/support/v4/widget/m;->b:F
...
.method public final addFocusables(Ljava/util/ArrayList;II)V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->x:Ljava/util/ArrayList;
...
.method public final addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/aa;->b(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/i;

    invoke-static {p1, v0}, Landroid/support/v4/view/aa;->a(Landroid/view/View;Landroid/support/v4/view/a;)V
...
.method public final computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/P;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/P;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/P;->a(Z)Z
...
.method public final d(Landroid/view/View;)V
    ...
    iput-boolean v1, v0, Landroid/support/v4/widget/m;->d:Z
...
.method protected final drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/P;
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/P;
...
.method protected final generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v4/widget/m;-><init>(II)V
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v4/widget/m;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected final generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/widget/m;-><init>(Landroid/support/v4/widget/m;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/widget/m;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/widget/m;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/P;

    invoke-virtual {v3, p1}, Landroid/support/v4/widget/P;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/P;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/P;->a(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/P;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/P;->b(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/P;->b(I)Z
...
.method protected final onLayout(ZIIII)V
    ...
    iget v1, v0, Landroid/support/v4/widget/m;->leftMargin:I

    iget v2, v0, Landroid/support/v4/widget/m;->topMargin:I

    iget v3, v0, Landroid/support/v4/widget/m;->leftMargin:I
    ...
    iget v0, v0, Landroid/support/v4/widget/m;->topMargin:I
    ...
    iget v3, v0, Landroid/support/v4/widget/m;->b:F
    ...
    :goto_3
    iget v4, v0, Landroid/support/v4/widget/m;->a:I

    and-int/lit8 v4, v4, 0x70

    sparse-switch v4, :sswitch_data_0

    iget v4, v0, Landroid/support/v4/widget/m;->topMargin:I

    add-int/2addr v9, v2

    iget v11, v0, Landroid/support/v4/widget/m;->topMargin:I
    ...
    iget v2, v0, Landroid/support/v4/widget/m;->b:F
    ...
    iget v10, v0, Landroid/support/v4/widget/m;->bottomMargin:I
    ...
    iget v11, v0, Landroid/support/v4/widget/m;->bottomMargin:I
    ...
    iget v12, v0, Landroid/support/v4/widget/m;->topMargin:I
    ...
    iget v13, v0, Landroid/support/v4/widget/m;->bottomMargin:I

    sub-int v13, v11, v13

    if-le v12, v13, :cond_5

    iget v4, v0, Landroid/support/v4/widget/m;->bottomMargin:I
...
.method protected final onMeasure(II)V
    ...
    iget v6, v0, Landroid/support/v4/widget/m;->leftMargin:I

    sub-int v6, v2, v6

    iget v7, v0, Landroid/support/v4/widget/m;->rightMargin:I
    ...
    iget v7, v0, Landroid/support/v4/widget/m;->topMargin:I

    sub-int v7, v1, v7

    iget v0, v0, Landroid/support/v4/widget/m;->bottomMargin:I
    ...
    invoke-static {v5}, Landroid/support/v4/view/aa;->k(Landroid/view/View;)F

    move-result v6

    iget v7, p0, Landroid/support/v4/widget/DrawerLayout;->e:F
    ...
    invoke-static {v5, v6}, Landroid/support/v4/view/aa;->e(Landroid/view/View;F)V
    ...
    iget v7, v0, Landroid/support/v4/widget/m;->width:I
    ...
    iget v8, v0, Landroid/support/v4/widget/m;->bottomMargin:I

    add-int/2addr v7, v8

    iget v0, v0, Landroid/support/v4/widget/m;->height:I
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v2, p1}, Landroid/support/v4/widget/P;->b(Landroid/view/MotionEvent;)V

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/P;
    ...
    iput v2, p0, Landroid/support/v4/widget/DrawerLayout;->s:F
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/support/v4/widget/P;

    float-to-int v5, v2

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/P;->b(II)Landroid/view/View;
...
.method public final setDrawerElevation(F)V
    ...
    invoke-static {v1, v2}, Landroid/support/v4/view/aa;->e(Landroid/view/View;F)V
...
.method public final setDrawerListener$1b20c458(Landroid/support/v7/app/h;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->r:Landroid/support/v7/app/h;
