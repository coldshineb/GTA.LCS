...
.method constructor <init>(Landroid/view/View;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/ArrayList;Landroid/transition/Transition;Landroid/view/View;)V
    ...
    iput-object p2, p0, Landroid/support/v4/app/J;->b:Landroid/transition/Transition;

    iput-object p3, p0, Landroid/support/v4/app/J;->c:Ljava/util/ArrayList;

    iput-object p4, p0, Landroid/support/v4/app/J;->d:Landroid/transition/Transition;

    iput-object p5, p0, Landroid/support/v4/app/J;->e:Ljava/util/ArrayList;

    iput-object p6, p0, Landroid/support/v4/app/J;->f:Landroid/transition/Transition;

    iput-object p7, p0, Landroid/support/v4/app/J;->g:Ljava/util/ArrayList;

    iput-object p8, p0, Landroid/support/v4/app/J;->h:Ljava/util/Map;

    iput-object p9, p0, Landroid/support/v4/app/J;->i:Ljava/util/ArrayList;

    iput-object p10, p0, Landroid/support/v4/app/J;->j:Landroid/transition/Transition;

    iput-object p11, p0, Landroid/support/v4/app/J;->k:Landroid/view/View;
...
.method public final onPreDraw()Z
    ...
    iget-object v0, p0, Landroid/support/v4/app/J;->b:Landroid/transition/Transition;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/J;->d:Landroid/transition/Transition;
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/J;->f:Landroid/transition/Transition;
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/J;->h:Ljava/util/Map;
    ...
    iget-object v4, p0, Landroid/support/v4/app/J;->j:Landroid/transition/Transition;
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v4/app/J;->j:Landroid/transition/Transition;

    iget-object v1, p0, Landroid/support/v4/app/J;->k:Landroid/view/View;
