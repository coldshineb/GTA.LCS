...
.method public final a(Landroid/support/v4/app/Z;Landroid/support/v4/app/aa;)Landroid/app/Notification;
    ...
    iget-object v3, p1, Landroid/support/v4/app/Z;->p:Landroid/app/Notification;
    ...
    iget-object v6, p1, Landroid/support/v4/app/Z;->e:Ljava/lang/CharSequence;
    ...
    iget v8, v3, Landroid/app/Notification;->icon:I

    iget v9, v3, Landroid/app/Notification;->iconLevel:I

    invoke-virtual {v0, v8, v9}, Landroid/app/Notification$Builder;->setSmallIcon(II)Landroid/app/Notification$Builder;

    move-result-object v0

    iget-object v8, v3, Landroid/app/Notification;->contentView:Landroid/widget/RemoteViews;
    ...
    iget-object v8, v3, Landroid/app/Notification;->tickerText:Ljava/lang/CharSequence;

    invoke-virtual {v0, v8, v12}, Landroid/app/Notification$Builder;->setTicker(Ljava/lang/CharSequence;Landroid/widget/RemoteViews;)Landroid/app/Notification$Builder;

    move-result-object v0

    iget-object v8, v3, Landroid/app/Notification;->sound:Landroid/net/Uri;

    iget v9, v3, Landroid/app/Notification;->audioStreamType:I

    invoke-virtual {v0, v8, v9}, Landroid/app/Notification$Builder;->setSound(Landroid/net/Uri;I)Landroid/app/Notification$Builder;
