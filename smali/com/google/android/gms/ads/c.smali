...
.method public final getAdListener$d37b066()Landroid/support/v4/app/q;
    ...
    iget-object v0, p0, Lcom/google/android/gms/ads/c;->a:Landroid/support/v4/media/session/MediaSessionCompat;
...
.method public final getInAppPurchaseListener$5c163a06()Landroid/support/v7/app/h;
    .locals 1

    iget-object v0, p0, Lcom/google/android/gms/ads/c;->a:Landroid/support/v4/media/session/MediaSessionCompat;

    invoke-virtual {v0}, Landroid/support/v4/media/session/MediaSessionCompat;->i()Landroid/support/v7/app/h;
...
.method protected final onLayout(ZIIII)V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/ads/c;->getChildAt(I)Landroid/view/View;
...
.method protected final onMeasure(II)V
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/gms/ads/c;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v0, p1, p2}, Lcom/google/android/gms/ads/c;->measureChild(Landroid/view/View;II)V
    ...
    :goto_0
    invoke-virtual {p0}, Lcom/google/android/gms/ads/c;->getSuggestedMinimumWidth()I
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/ads/c;->getSuggestedMinimumHeight()I
    ...
    invoke-virtual {p0, v1, v0}, Lcom/google/android/gms/ads/c;->setMeasuredDimension(II)V

    return-void

    :cond_0
    invoke-virtual {p0}, Lcom/google/android/gms/ads/c;->getAdSize()Lcom/google/android/gms/ads/b;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lcom/google/android/gms/ads/c;->getContext()Landroid/content/Context;
...
.method public final setAdListener$3b914f14(Landroid/support/v4/app/q;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat;->a(Lcom/google/android/gms/ads/internal/client/a;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/media/session/MediaSessionCompat;->a(Lcom/google/android/gms/ads/internal/client/a;)V
...
.method public final setInAppPurchaseListener$521ae500(Landroid/support/v7/app/h;)V
    .locals 1

    iget-object v0, p0, Lcom/google/android/gms/ads/c;->a:Landroid/support/v4/media/session/MediaSessionCompat;

    invoke-virtual {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat;->b(Landroid/support/v7/app/h;)V
